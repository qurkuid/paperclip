...
const priorityConfig: Record<string, { icon: typeof ArrowUp; color: string; label: string }> = {
  critical: { icon: AlertTriangle, color: priorityColor.critical ?? priorityColorDefault, label: koMenu("Critical") },
  high: { icon: ArrowUp, color: priorityColor.high ?? priorityColorDefault, label: koMenu("High") },
  medium: { icon: Minus, color: priorityColor.medium ?? priorityColorDefault, label: koMenu("Medium") },
  low: { icon: ArrowDown, color: priorityColor.low ?? priorityColorDefault, label: koMenu("Low") },
};
